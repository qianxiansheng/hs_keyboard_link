...
KLFunctionLayout functionLayout[] = {
	...
	KLFunctionLayout(KLF_UP      , u8"↑"         , {1.25f, 0.0f, 1.0f, 1.0f}),
	...
	KLFunctionLayout(KLF_LEFT    , u8"←"         , {0.25f, 0.0f, 1.0f, 1.0f}),
	KLFunctionLayout(KLF_DOWN    , u8"↓"         ),
	KLFunctionLayout(KLF_RIGHT   , u8"→"         ),
